...
class ConfmgtCkModelRevrs extends ConfmgtClassModelList
{
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		//WHERE - SEARCH : search_search : search on Title + First Name + Surname + Email + Affiliation
...
JLoader::register('ConfmgtModelRevrs', JPATH_SITE_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'revrs.php');
