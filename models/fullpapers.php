...
class ConfmgtCkModelFullpapers extends ConfmgtClassModelList
{
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		//WHERE - SEARCH : search_search : search on Full paper + Paper ID > Abstract + Paper ID > Title + Paper ID + Paper ID > Key words
		$search_search = $this->getState('search.search');
		$this->addSearch('search', 'a.full_paper', 'like');
		$this->addSearch('search', '_paper_id_.abstract', 'like');
		$this->addSearch('search', '_paper_id_.title', 'like');
		$this->addSearch('search', 'a.paper_id', 'like');
...
JLoader::register('ConfmgtModelFullpapers', JPATH_SITE_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'fullpapers.php');
