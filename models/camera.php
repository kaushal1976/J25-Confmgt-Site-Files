...
class ConfmgtCkModelCamera extends ConfmgtClassModelList
{
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		//WHERE - SEARCH : search_search : search on Paper ID > Title + Paper ID > Key words + Title
...
JLoader::register('ConfmgtModelCamera', JPATH_SITE_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'camera.php');
