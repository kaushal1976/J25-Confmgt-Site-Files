...
?>
<?php $fieldSet = $this->form->getFieldset('fullpaper.form');?>
<fieldset class="fieldsform form-horizontal">
	<legend><?php echo JText::_($fieldSets['fullpaper.form']->label);?></legend>
	...
	$fieldSet['jform_full_paper']->jdomOptions = array(
