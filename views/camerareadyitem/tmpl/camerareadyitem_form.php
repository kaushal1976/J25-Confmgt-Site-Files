...
?>
<?php $fieldSet = $this->form->getFieldset('camerareadyitem.form');?>
<fieldset class="fieldsform form-horizontal">
	<legend><?php echo JText::_($fieldSets['camerareadyitem.form']->label);?></legend>
	...
	$fieldSet['jform_camera_ready_paper']->jdomOptions = array(
