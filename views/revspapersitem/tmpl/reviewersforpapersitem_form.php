...
?>
<?php $fieldSet = $this->form->getFieldset('reviewersforpapersitem.form');?>
<fieldset class="fieldsform form-horizontal">

	<?php
	// JForms dynamic initialization (Cook Self Service proposal)
	$fieldSet['jform_paper']->jdomOptions = array(
			'list' => $this->lists['fk']['paper']
		);
	$fieldSet['jform_reviewer']->jdomOptions = array(
			'list' => $this->lists['fk']['reviewer']
		);
